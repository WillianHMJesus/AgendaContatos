...
namespace TrabalhoUWP.View
{
    ...
    public sealed partial class Favoritos : Page
    {
        ...
        public Favoritos()
        {
            ...
            VisualStateGroupScreenWidth.CurrentStateChanged += Favoritos_CurrentStateChanged;
        ...
        private void Favoritos_CurrentStateChanged(object sender, VisualStateChangedEventArgs e)
        {
